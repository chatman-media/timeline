...
// Типы предустановок
type PresetType = "Timeline" | "Wondershare Filmora" | "Adobe Premier Pro"
...
// Функция для создания предустановок с локализацией
function createPresets(t: any): Record<PresetType, ShortcutCategory[]> {
  return {
    Timeline: [
      {
        id: "preferences",
      ...
      },
      {
        ...
        shortcuts: [
          ...
          { id: "cut", name: t("dialogs.keyboardShortcuts.shortcuts.cut", "Вырезать"), keys: "⌘X" },
          {
            id: "copy",
    ...
    "Adobe Premier Pro": [
      ...
      // Другие категории для Premier Pro...
    ],
  }
}
...
export function KeyboardShortcutsDialog({ open, onOpenChange }: KeyboardShortcutsDialogProps) {
  ...
  const PRESETS = useMemo(() => createPresets(t), [t, i18n.language])
                    ...
                    <div className="space-y-2">
                      {category.shortcuts.map((shortcut, shortcutIndex) => {
                        ...
                        return (
                          <div
                            key={shortcut.id}
                            className={`flex items-center justify-between rounded px-2 py-2 hover:bg-gray-50 dark:hover:bg-gray-800 ${isEditing ? "ring-2 ring-[#00CCC0]" : ""} cursor-pointer`}
                            onClick={(e) => {
                              e.stopPropagation()
                          ...
                          >
                            ...
                            <div
                              className={`px-3 py-1.5 ${isEditing ? "bg-[#00CCC0] text-black" : "bg-gray-100 dark:bg-gray-800"} min-w-[80px] rounded text-center font-mono text-sm font-medium transition-all`}
                            >
                              {isEditing ? (
