...
/**
 * Шаблон "4 экрана: 1 сверху + 3 снизу" - портретный формат
 * ID: split-1-3-bottom-portrait
 */
export function Split13BottomPortrait({
  videos,
  activeVideoId,
  videoRefs,
  isResizable = true,
