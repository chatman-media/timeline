 ...
 */
export function SplitDiagonalLandscape({ videos, activeVideoId, videoRefs, isResizable = true, templateId }: TemplateProps & { templateId?: string }) {
  ...
  console.log(`[SplitDiagonalLandscape] Рендеринг шаблона ${templateId} с параметрами:`, {
    isPortrait, isSquare, isVertical, isResizable
  });
    ...
    return (
      ...
      >
        ...
        {validVideos.slice(0, videoCount).map((video, index) => {
          ...
          const clipPaths = isSquare && !isVertical ?
            [
